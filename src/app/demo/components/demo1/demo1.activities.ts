export const lesson = {
  ...
  description: [`In this demo we use different ways to listen to the events of a button click.`],
  showContent: false,
  showResult: false,
};
...
export const activity2 = {
  ...
  description: [`The second button uses the <code>fromEvent</code> Observable.`],
  solution: `
